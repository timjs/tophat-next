...
\newmacro{G-Values}{
  \begin{grammar}
    ...
    \addlinespace
      % &      &\mid& u\ v                 & – unary operation \\
      % &      &\mid& v_1\ o\ v_2          & – binary operation \\
      &      &\mid& t                    & – task \\
  \end{grammar}
}
...
\newmacro{G-Tasks}{
  \begin{grammar}
    Tasks
      & t    &::= & \Enter \tau          & – unvalued editor \\
      &      &\mid& \Update v            & – valued editor \\
