...
\begin{proof}
  ...
  \case
    ...
    The induction hypothesis gives us that $e\eval t$ also preverves, and thus $\Gamma,\Sigma\infers t:\Task \tau$.
    Therefore $\Gamma,\Sigma\infers \Forever t : \Task \Void$\todo{somehting strange is going on here. Type information is deleted, and therefore, forever always preserves (since result type is void)}}
