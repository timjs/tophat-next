...
\newoperator{Update}{\square}
\newoperator{View}  {\dot{\square}} %{\boxcircle} %{\overline{\square}}
\newoperator{Pick}  {\lozenge}

\newoperator{Pair}  {\Join}
\newoperator{Done}  {\blacksquare}
\newoperator{Choose}{\blacklozenge}
\newoperator{Fail}  {\lightning}

\newoperator{Trans}  {\blacktriangle} %{\bullet}
\newoperator{Step}   {\blacktriangleright}
\newoperator{Forever}{\circlearrowleft}

\newoperator{Change}{\boxplus}
\newoperator{Watch} {\dot{\boxplus}} %{\boxbox} %{\overline{\boxplus}}
