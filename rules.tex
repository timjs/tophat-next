...
\newrule{H-FirstAnd}
  {t_1,\sigma \xrightarrow[]{j} t_1',\sigma'}
  {t_1 \And t_2,\sigma \xrightarrow[]{\First j} t_1' \And t_2,\sigma'}

\newrule{H-SecondAnd}
  {t_2,\sigma \xrightarrow[]{j} t_2',\sigma'}
  {t_1 \And t_2,\sigma \xrightarrow[]{\Second j} t_1 \And t_2',\sigma'}


\newrule{H-FirstOr}
  {t_1,\sigma \xrightarrow[]{j} t_1',\sigma'}
  {t_1 \Or t_2,\sigma \xrightarrow[]{\First j} t_1' \Or t_2,\sigma'}

\newrule{H-SecondOr}
  {t_2,\sigma \xrightarrow[]{j} t_2',\sigma' }
  {t_1 \Or t_2,\sigma \xrightarrow[]{\Second j} t_1 \Or t_2',\sigma'}
