...
\newmacro{RelationH}
  {t,\sigma \handle{a} t',\sigma',\delta'}
...
\newrule{H-Trans}
	{t_2,\sigma \handle{a} t_2',\sigma',\delta'}
	{e_1 \Trans t_2,\sigma \handle{a} e_1 \Trans t_2',\sigma',\delta'}

\newrule{H-Forever}
  {t \Step \lambda\_. \Forever t,\sigma \handle{a} t',\sigma',\delta'}
  {\Forever t,\sigma \handle{a} t',\sigma',\delta'}

\newrule{H-Step}
  {t_1,\sigma \handle{a} t_1',\sigma',\delta'}
  {t_1 \Step e_2,\sigma \handle{a} t_1' \Step e_2,\sigma',\delta'}
  [a \neq \IContinue L_j]

\newrule{H-PairFirst}
  {t_1,\sigma \handle{a} t_1',\sigma',\delta'}
  {t_1 \Pair t_2,\sigma \handle{a} t_1' \Pair t_2,\sigma',\delta'}
...
\newrule{H-ChooseFirst}
  {t_1,\sigma \handle{a} t_1',\sigma',\delta'}
  {t_1 \Choose t_2,\sigma \handle{a} t_1' \Choose t_2,\sigma',\delta'}
...
\newmacro{RelationI}
  {t,\sigma \interact{a} t',\sigma'}


\newrule{I-Handle}
  {t,\sigma \handle{a} t',\sigma',\delta' \Quad
   t',\sigma',\delta' \fix t'',\sigma''}
  {t,\sigma \interact{a} t'',\sigma''}
